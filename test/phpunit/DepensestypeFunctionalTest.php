...
/**
 * \file    test/phpunit/DepensestypeFunctionalTest.php
...
/**
 * Class DepensestypeFunctionalTest
 *
 ...
 *
 * @package Testdepensestype
 */
class DepensestypeFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modDepensestype')->click();
		} else {
			// Disable the module
			$this->byHref('modDepensestype')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/depensestype/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('depensestype/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/depensestype/admin/about.php');
		$this->authenticate();
		return $this->assertContains('depensestype/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('depensestypewidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modDepensestype_DepensestypeTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modDepensestype_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
